...
export function create(filter: () => void, logger?): {(): void, register: (handler: ()=> void) => void}
export function create<A, B>(filter: (a: A) => B, logger?): {(a: A): void, register: (handler: (m: B)=> void) => void}
